...
enum {
    ...
    FUN_GAME, // Function key layer for gaming
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //`-------+-------+-------+-----+-+-------+-------+-------/    \-------+-------+-------+-------+-------+-------+-------'
                                   KC_LGUI,KC_LALT, KC_SPC,         KC_ENT  ,KC_FGAM,  ___
  //                              `-------+-------+-------'        `--------+-------+-------'
  ),
  ...
  //,-------+-------+-------+-------+-------+-------.                    ,-------+-------+-------+-------+-------+-------.
     KC_MAIN, KC_1  , KC_2  , KC_3  , KC_4  , KC_5  ,                      KC_6  , KC_7  , KC_8  , KC_9  , KC_0  ,  ___  ,
  //|-------+-------+-------+-------+-------+-------|                    |-------+-------+-------+-------+-------+-------|
      KC_TAB, KC_ESC, KC_Q  , KC_W  , KC_E  , KC_R  ,                      KC_Y  , KC_INS,KC_HOME,KC_PGUP, KC_P  ,  ___  ,
  //|-------|-------+-------+-------+-------+-------+                    |-------+-------+-------+-------+-------+-------|
      KC_T  ,KC_LSFT, KC_A  , KC_S  , KC_D  , KC_F  ,                      KC_H  , KC_DEL, KC_END,KC_PGDN, KC_T  ,KC_GAME,
  //|-------+-------+-------+-------+-------+-------+-------.    ,-------|-------+-------+-------+-------+-------+-------|
      KC_M  ,KC_LCTL, KC_Z  , KC_X  , KC_C  , KC_V  ,  ___  ,       ___  , KC_N  , KC_M  , KC_G  , KC_B  ,  ___  ,KC_AGAM,
  //`-------+-------+-------+-----+-+-------+-------+-------/    \-------+-------+-------+-------+-------+-------+-------'
                                   KC_LGUI,KC_LALT, KC_SPC,         KC_ENT  ,KC_FGAM,  ___
  ...
  //,-------+-------+-------+-------+-------+-------.                    ,-------+-------+-------+-------+-------+-------.
     KC_MAIN, KC_1  , KC_2  , KC_3  , KC_4  , KC_5  ,                      KC_6  , KC_7  , KC_8  , KC_9  , KC_0  ,  ___  ,
  //|-------+-------+-------+-------+-------+-------|                    |-------+-------+-------+-------+-------+-------|
      KC_TAB, KC_ESC, KC_Q  , KC_W  , KC_E  , KC_R  ,                      KC_Y  , KC_U  , KC_UP , KC_O  , KC_P  ,  ___  ,
  //|-------|-------+-------+-------+-------+-------+                    |-------+-------+-------+-------+-------+-------|
      KC_T  ,KC_LSFT, KC_A  , KC_S  , KC_D  , KC_F  ,                      KC_H  ,KC_LEFT,KC_DOWN,KC_RGHT, KC_T  ,KC_NGAM,
  //|-------+-------+-------+-------+-------+-------+-------.    ,-------|-------+-------+-------+-------+-------+-------|
      KC_M  ,KC_LCTL, KC_Z  , KC_X  , KC_C  , KC_V  ,  ___  ,       ___  , KC_N  , KC_M  , KC_G  , KC_B  ,  ___  ,KC_GAME,
  //`-------+-------+-------+-----+-+-------+-------+-------/    \-------+-------+-------+-------+-------+-------+-------'
                                   KC_LGUI,KC_LALT, KC_SPC,         KC_ENT  ,KC_FGAM,  ___
  //                              `-------+-------+-------'        `--------+-------+-------'
  ),

  // Layer with function keys for gaming
    [_FUN_GAME] = LAYOUT(
  //,-------+-------+-------+-------+-------+-------.                    ,-------+-------+-------+-------+-------+-------.
